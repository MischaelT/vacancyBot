...
from frontend.data.buttons import (ANALYST_BUTTON, ARCHITECT_BUTTON,
                                   ...
                                   RUN_PARSING_BUTTON, SALARY1_BUTTON,
                                   SALARY2_BUTTON, SALARY3_BUTTON,
                                   SALARY4_BUTTON, SCALA_BUTTON,
...
SALARIES_LIST = [SALARY1_BUTTON, SALARY2_BUTTON, SALARY3_BUTTON, SALARY4_BUTTON]
